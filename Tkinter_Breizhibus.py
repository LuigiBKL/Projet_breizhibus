...
#Fonction permettant d'afficher les arrets demandés par l'utilisateur à l'aide la combobox        
    ...
    def ajout_bus (self):
        ...
        ajout = Connexion().ajout_bus(self.entree,self.entree1,self.entree2,self.entree3)
    ...
    def construction(self):
        ...
        self.liste_bus = ["13","14","15"]
        self.listeCombo = ttk.Combobox(self.frame,values =self.liste_bus)
        ...
        self.bouton4 = Button ( self.frame , text = "Afficher les informations sur les bus" , font = ( "Algerian", 11 ), bg = "#55557f", fg= "white" , height = 1, width = 33,command= lambda: self.affichage_info_bus())
        ...
        self.bouton2 = Button (self.frame ,text = "Ajouter", font = ( "Algerian", 11 ), bg = "#55557f" , fg = "White" , height = 1 , width = 12, command = lambda: self.ajout_bus())
        self.bouton3 = Button (self.frame ,text = "Modifier", font = ( "Algerian", 11 ), bg = "#55557f" , fg = "White" , height = 1 , width = 12)
        ...
        #self.entree.pack (side = "right",pady = 5)
